...
/**
 * Created by zcc on 2016/8/22.
 */
public class FlowLiner extends LinearLayout {
    private static final String TAG = "FlowRadioGroup";
    public FlowLiner(Context context) {
        super(context);
    }

    public FlowLiner(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
