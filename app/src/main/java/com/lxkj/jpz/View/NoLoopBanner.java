 ...
 * @since 2019/12/21
 */
public class NoLoopBanner extends FrameLayout implements OnPageChangeListener {
    public String tag = "NoBanner";
    ...
    public NoLoopBanner(Context context) {
        this(context, null);
    }

    public NoLoopBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoLoopBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public NoLoopBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public NoLoopBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public NoLoopBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public NoLoopBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public NoLoopBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return NoBanner
     */
    public NoLoopBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return NoBanner
     */
    public NoLoopBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public NoLoopBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public NoLoopBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public NoLoopBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public NoLoopBanner setImages(List<?> imageUrls) {
    ...
    private void setTitleStyleUI() {
        if (titles.size() != imageUrls.size()) {
            throw new RuntimeException("[NoBanner] --> The number of titles and images is different");
        }
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public NoLoopBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public NoLoopBanner setOnBannerListener(OnBannerListener listener) {
