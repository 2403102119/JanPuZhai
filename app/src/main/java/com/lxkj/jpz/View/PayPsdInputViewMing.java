 ...
 *
 */
public class PayPsdInputViewMing extends AppCompatEditText {
    ...
    public PayPsdInputViewMing(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PayPsdInputViewMing);
        maxCount = typedArray.getInt(R.styleable.PayPsdInputViewMing_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdInputViewMing_circleColor, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputViewMing_bottomLineColor, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputViewMing_radius, radius);
        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputViewMing_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdInputViewMing_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdInputViewMing_psdType, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputViewMing_rectAngle, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.PayPsdInputViewMing_focusedColor, focusedColor);
    ...
    private void initPaint() {
        ...
        textPaint  = getPaint(10, Paint.Style.FILL, circleColor);
...
//       super.onDraw(canvas);
    ...
    private void drawPsdCircle(Canvas canvas) {
        char [] strArr  = contentText.toCharArray();
        for (int i = 0; i < textLength; i++) {
//            canvas.drawCircle(startX + i * 2 * startX,
//                    startY,
//                    radius,
//                    circlePaint);
            canvas.drawText(String.valueOf(strArr[i]),startX + i * 2 * startX,
                    startY,
                    textPaint);
        }
    }
