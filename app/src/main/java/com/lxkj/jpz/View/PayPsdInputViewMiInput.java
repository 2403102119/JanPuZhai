 ...
 * 密文包含文本框
 */
public class PayPsdInputViewMiInput extends AppCompatEditText {
    ...
    public PayPsdInputViewMiInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PayPsdInputViewMi);
        maxCount = typedArray.getInt(R.styleable.PayPsdInputViewMi_maxCount1, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdInputViewMi_circleColor1, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputViewMi_bottomLineColor1, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputViewMi_radius1, radius);
        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputViewMi_divideLineWidth1, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdInputViewMi_divideLineColor1, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdInputViewMi_psdType1, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputViewMi_rectAngle1, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.PayPsdInputViewMi_focusedColor1, focusedColor);
