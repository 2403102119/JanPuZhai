...
import com.lxkj.jpz.Adapter.TowAdapter;
...
//        drawable = getResources().getDrawable(R.color.two);
...
//        rl_title.setBackgroundDrawable(drawable);
    ...
    protected void initEvent() {
        ...
        adapter=new TowAdapter(TwoActivity.this,list);
        recycle.setAdapter(adapter);
        adapter .setOnItemClickListener(new TowAdapter.OnItemClickListener() {
            @Override
            public void OnItemClickListener(int position) {
                ...
                Intent intent = new Intent(TwoActivity.this,DeatilsActivity.class);
